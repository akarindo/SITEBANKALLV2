			...
			<div class="search-result__content">
				...
				<div class="mb-5">
					<a href="" class="flex items-center mt-2">
						<div class="w-8 h-8 image-fit">
							<img alt="Midone - HTML Admin Template" class="rounded-full"
								src="{{asset('admin/dist/images/profile-15.jpg')}}">
						</div>
					...
					<a href="" class="flex items-center mt-2">
						...
						<div class="ml-auto w-48 truncate text-slate-500 text-xs text-right">christianbale@left4code.com
						</div>
					</a>
					<a href="" class="flex items-center mt-2">
						<div class="w-8 h-8 image-fit">
							<img alt="Midone - HTML Admin Template" class="rounded-full"
								src="{{asset('admin/dist/images/profile-8.jpg')}}">
						</div>
					...
					<a href="" class="flex items-center mt-2">
						...
						<div class="ml-auto w-48 truncate text-slate-500 text-xs text-right">russellcrowe@left4code.com
						</div>
					</a>
				</div>
				...
				<a href="" class="flex items-center mt-2">
					<div class="w-8 h-8 image-fit">
						<img alt="Midone - HTML Admin Template" class="rounded-full"
							src="{{asset('admin/dist/images/preview-7.jpg')}}">
					</div>
					<div class="ml-3">Nikon Z6</div>
					<div class="ml-auto w-48 truncate text-slate-500 text-xs text-right">Photography</div>
				</a>
		...
		<div class="dropdown-menu w-56">
			<ul class="dropdown-content bg-primary text-white">
				<li class="p-2">
					...
					<div class="text-xs text-white/70 mt-0.5 dark:text-slate-500">{{ config('subdomain.APP_NAME') }}
					</div>
				</li>
				<li>
				...
				<li>
					<a href="{{ route('logout') }}"
						...
						class="dropdown-item hover:bg-white/5"> <i data-lucide="toggle-right" class="w-4 h-4 mr-2"></i>
						Logout
